				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						<select name="weblizar_page_out_trans" id="weblizar_page_out_trans" style="width:80%;">
							...
							<option value="overlay-slide-out-bottom" <?php if ('overlay-slide-out-bottom' == $weblizar_page_out_trans) echo esc_html('selected="selected"'); ?>>Overlay Slide Out Top',WL_PAT_DOMAIN); ?></option>
