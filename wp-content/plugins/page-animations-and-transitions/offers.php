...
<div class="col-md-10  product-main-cont">			
	...
	<ul class="nav nav-tabs product-tbs">
		<li class=""><a data-toggle="tab" href="#themesd" onclick="themes()"><?php esc_html_e('Themes',WL_PAT_DOMAIN); ?> </a></li>
		<li><a data-toggle="tab" href="#pluginsd" onclick="plugins1()"><?php esc_html_e('Plugins',WL_PAT_DOMAIN); ?></a></li>
		<li><a data-toggle="tab" href="#offers2" onclick="offers()"><?php esc_html_e('Offers',WL_PAT_DOMAIN); ?></a></li>
	</ul>
